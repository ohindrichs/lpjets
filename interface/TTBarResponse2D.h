...
class TTBarResponse2D
{
	...
	public:
		...
		~TTBarResponse2D();
		void AddMatrix(string name, const vector<double>& Mbinsx, const vector<double>& Mbinsy, const vector<double>& Tbinsx, const vector<double>& Tbinsy, bool ofx = false, bool ofy = false);
